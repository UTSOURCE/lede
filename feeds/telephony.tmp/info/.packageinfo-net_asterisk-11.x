...
Submenu: Telephony
Version: 11.25.1-2
Depends: +libc +SSP_SUPPORT:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread +libopenssl +libedit +libncurses +libpopt +libpthread +libsqlite3 +librt +libuuid +zlib @!TARGET_avr32
...
@@
Config:
	source "feeds/telephony/net/asterisk-11.x/Config.in"
@@
...
Submenu: Telephony
Version: 11.25.1-2
Depends: +libc +SSP_SUPPORT:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread asterisk11 +PACKAGE_asterisk11-chan-dahdi:dahdi-tools-libtonezone +PACKAGE_asterisk11-chan-dahdi:kmod-dahdi +PACKAGE_asterisk11-chan-dahdi:libpri @!aarch64
Conflicts: 
Menu-Depends: 
Provides: 
Build-Depends: libxml2/host
...
Submenu: Telephony
Version: 11.25.1-2
Depends: +libc +SSP_SUPPORT:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread asterisk11 +PACKAGE_asterisk11-pgsql:libpq @!arc
Conflicts: 
Menu-Depends: 
Provides: 
Build-Depends: libxml2/host
...
LicenseFiles: COPYING LICENSE
Type: ipkg
Description: This package provides support for 'Realtime CLI' in Asterisk11.
http://www.asterisk.org/
Jiri Slachta <jiri@slachta.eu>
@@
...
LicenseFiles: COPYING LICENSE
Type: ipkg
Description: This package provides support for 'DAHDI timing interface' in Asterisk11.
http://www.asterisk.org/
Jiri Slachta <jiri@slachta.eu>
@@
...
LicenseFiles: COPYING LICENSE
Type: ipkg
Description: This package provides support for 'POSIX pthreads Timing Interface' in Asterisk11.
http://www.asterisk.org/
Jiri Slachta <jiri@slachta.eu>
@@
...
LicenseFiles: COPYING LICENSE
Type: ipkg
Description: This package provides support for 'Timing interface provided by Linux kernel' in Asterisk11.
http://www.asterisk.org/
Jiri Slachta <jiri@slachta.eu>
@@
